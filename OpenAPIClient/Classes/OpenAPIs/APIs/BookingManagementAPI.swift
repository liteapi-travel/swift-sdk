...
open class BookingManagementAPI {
     ...
     */
    @discardableResult
    open class func bookingsBookingIdPut(bookingId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func bookingsGet(guestId: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
